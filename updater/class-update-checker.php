<?php
if (!class_exists('WSSMGK_Update_Checker')) {

    class WSSMGK_Update_Checker {
        ...
        public function __construct() {
            $utility = wssmgk_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'wssmgk_plugin_updates';
